...
import {
  ...
  CalendarDays, RefreshCw, CheckCircle, Clock, FileText, ChevronDown
} from 'lucide-react';
import { agendaApi } from '../../lib/api';
import CustomSelect from '../../components/ui/CustomSelect';

export default function AgendaPimpinanStafProtokolPage() {
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="relative flex-1 group">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-blue-100 bg-white rounded-xl text-sm w-full focus:ring-2 focus:ring-blue-500 outline-none shadow-sm"
              />
            </div>
