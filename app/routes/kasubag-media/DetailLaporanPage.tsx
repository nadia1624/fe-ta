...
export default function DetailLaporanPage() {
  ...
  // Mock data - harus match dengan ID dari LaporanKegiatanPage
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Timeline Progress Dokumentasi</h3>
            </div>
            <Badge variant="info">{laporan.progress.length} Update</Badge>
          </div>
          <p className="text-sm text-gray-600 mt-1">Laporan ini hanya dapat dilihat (Read Only - Kasubag Media)</p>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 text-center">
              ...
              <p className="text-2xl font-semibold text-purple-600">{laporan.progress.length}</p>
