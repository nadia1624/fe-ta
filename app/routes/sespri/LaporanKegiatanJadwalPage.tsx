...
export default function LaporanKegiatanJadwalPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">Laporan Kegiatan per Jadwal Pimpinan</h1>
        <p className="text-sm text-gray-600 mt-1">Laporan dokumentasi dan hasil kegiatan pimpinan</p>
      </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-semibold text-blue-600">{totalLaporan}</p>
              </div>
