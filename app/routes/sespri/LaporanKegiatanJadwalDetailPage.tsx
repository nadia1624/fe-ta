...
export default function LaporanKegiatanJadwalDetailPage() {
  const { id } = useParams();
  const navigate = useNavigate();

  // Mock data - harus match dengan ID dari LaporanKegiatanJadwalPage
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">{laporan.judul_kegiatan}</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-900 mt-1 font-semibold">{laporan.pimpinan_nama}</p>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Timeline Progress Protokoler</h3>
            </div>
            <Badge variant="info">{laporan.progress.length} Update</Badge>
          </div>
          <p className="text-sm text-gray-600 mt-1">Laporan kegiatan protokoler dari Tim Protokol</p>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
              ...
              <p className="text-2xl font-semibold text-blue-600">{laporan.progress.length}</p>
