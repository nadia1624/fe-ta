...
export default function AgendaPimpinanPage() {
  ...
  const agendaList = [
    ...
    },
    {
      ...
      sumber: 'Sespri Input',
      created_by: 'Sespri - Ahmad',
      nomor_surat: '007/SP/II/2026',
      perihal: 'Rapat evaluasi Satgas COVID-19',
      pemohon: 'Ketua Satgas COVID-19',
      instansi: 'Gugus Tugas COVID-19'
    },
    {
      id: 9,
      pimpinan: 'Ir. Hj. Siti Rahmawati, M.T',
      ...
      sumber: 'Sespri Input',
      created_by: 'Sespri - Ahmad',
      nomor_surat: '006/SP/II/2026',
      perihal: 'Kunjungan monitoring puskesmas',
      pemohon: 'Kepala Puskesmas Sejahtera',
      instansi: 'Puskesmas Sejahtera'
    },
    {
      id: 10,
      pimpinan: 'Dr. H. Ahmad Suryadi, M.Si',
      ...
      perihal: 'Rapat evaluasi kinerja OPD',
    ...
    },
    {
      ...
      sumber: 'Sespri Input',
      created_by: 'Sespri - Ahmad',
      nomor_surat: '016/SP/II/2026',
      perihal: 'Sosialisasi program pemberdayaan UMKM',
      pemohon: 'Kepala Dinas Koperasi',
    ...
    },
    {
      ...
      pimpinan: 'Dr. H. Ahmad Suryadi, M.Si',
      jabatan: 'Walikota',
      judul_kegiatan: 'Peresmian Pasar Rakyat',
      tanggal: '2026-02-14',
      waktu_mulai: '08:00',
      waktu_selesai: '09:30',
      tempat: 'Pasar Sejahtera',
      keterangan: 'Peresmian renovasi pasar rakyat',
      status: 'Terkonfirmasi',
      sumber: 'Sespri Input',
      created_by: 'Sespri - Ahmad',
      nomor_surat: '017/SP/II/2026',
      perihal: 'Peresmian pasar rakyat pasca renovasi',
      pemohon: 'Kepala Dinas Perdagangan',
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-semibold text-blue-600">{agendaList.length}</p>
              </div>
